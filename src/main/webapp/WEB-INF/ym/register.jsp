			...
			<div class="dl_con">
				...
				<ul>
					...
					<%-- <li style="border: none;">
						<i><img src="${configjscss }/images/zc-ico.png"></i>
						<span><input id="userAccount" name="userAccount" type="text" placeholder="邀请码"></span>
					</li> --%>
				</ul>
				<div class="btn">
				...
				<div class="btn">
					<a rel="external" href="javascript:void(0)" onclick="history.go(-1)" class="com_btn">上一步</a>
				</div>
				<div class="forget">
					<p>
